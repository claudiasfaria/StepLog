...
export function Icon({ d, size = 16, style = {}, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export const ICONS = {
  ...
  cap:     "M22 10v6M2 10l10-5 10 5-10 5-10-5zM6 12v5c3.33 1.33 8 2 12-5c0 0-2.5 2-6 2",
  ...
  mapPin:  "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0zM12 7a3 3 0 1 0 0 6 3 3 0 0 0 0-6",
} as const;